            ...
            <form action="<?php echo e(route('register')); ?>" method="post" autocomplete="off">
                <?php echo csrf_field(); ?>
                    <label for="name">Name</label>
                        <input type="text" id="name" name="name" value="<?php echo e(old('name')); ?>" required autofocus placeholder="John Doe" />
...
unset($__errorArgs, $__bag); ?>
                    <label for="email">Email</label>
                        <input type="email" id="email" name="email" value="<?php echo e(old('email')); ?>" required placeholder="john@example.com" />
...
</html><?php /**PATH /var/www/u2575153/data/www/smart-resources.tech/resources/views/auth/register.blade.php ENDPATH**/ ?>